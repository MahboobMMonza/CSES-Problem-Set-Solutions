...
int main() {
    fio;
    // Binary search how many 2s are required to take from the left pile. If the remaining value matches the number of
    // 2s from the right pile, then it is possible.

    ll t, a, b, left, right, s, rem, takes;
    cin >> t;
    while (t--) {
        cin >> a >> b;
        left = 0, right = a / 2;
