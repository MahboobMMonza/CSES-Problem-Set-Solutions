...
int main() {
    fio;
    /**
     * Let x be number of 2's taken from a
     * Let y be number of 2's taken from b
     *
     * Since 3 coins are taken in any move,
     ...
     * 1a = 2x + 1y
     * ------------
     * 2b - a = 3y => Must be NON-NEGATIVE ==> 2b - a >= 0 => 2b >= a
     *
     * 2 * e1 - e2:
     *
     * 2a = 4x + 2y
     * 1b = 1x + 2y
     * ------------
     * 2a - b = 3x => Must be NON-NEGATIVE ==> 2a - b >= 0 => 2a >= b
     *
     */
     ll t, a, b;
     cin >> t;
