...
int main() {
    /**
     * PSA, but sum operation is replaced by XOR (PXA). XOR sum of [a, b] = pxa[b] ^ pxa[a - 1]. This is because
     * x ^ y ^ x = y. pxa[b] is xor_idx(1..b) and pxa[a - 1] is xor_idx(1..a-1). pxa[b] can be written as
     * xor_idx(1..a-1) ^ xor_idx(a..b) because XOR is associative. So to isolate xor_idx(a..b), XOR with
     * xor_idx(1..a-1).
     */
    fio;
    int n, q, a, b;
