...
int main() {
    /**
     * Set each stick to be the same length as the median value. This value will always be a smaller distance away from
     * either end than any other value, so the cost will be the lowest overall.
     */
    fio;
    const int MX = 2e5+5;
    int n, mp;
